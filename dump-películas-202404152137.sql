...
-- Started on 2024-04-15 21:37:12
...
-- Completed on 2024-04-15 21:37:12
...
--
-- TOC entry 4841 (class 1262 OID 32800)
-- Name: películas; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE "películas" WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'Spanish_Chile.1252';


ALTER DATABASE "películas" OWNER TO postgres;

\connect -reuse-previous=on "dbname='películas'"
...
--
-- TOC entry 4834 (class 0 OID 32801)
-- Dependencies: 215
-- Data for Name: peliculas; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.peliculas (id, "Pelicula", "Año estreno", "Director") FROM stdin;
...
--
-- TOC entry 4835 (class 0 OID 32804)
-- Dependencies: 216
-- Data for Name: reparto; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.reparto (id_pelicula, actor) FROM stdin;
1	Tom Hanks
1	Robin Wright Penn
1	Gary Sinise
